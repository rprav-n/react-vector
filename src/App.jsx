      ...
      <div style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', gap: '1rem', paddingBottom: '1rem' }}>
        <div style={{display: 'flex', justifyContent:'center', alignItems:'center', flexDirection:'column', gap:'1rem'}}>
          <div>
            ...
            <input type="range" name='width' id='width' step={20} min={400} max={1000} value={gridSize.width} onChange={e => {
              setGridSize({
          ...
          <div>
            ...
            <input type="range" name='height' id='height' step={20} min={400} max={1000} value={gridSize.height} onChange={e => {
              setGridSize({
